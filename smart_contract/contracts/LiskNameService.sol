...
contract LiskNameService is Initializable, OwnableUpgradeable,
ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    uint256 public constant PRICE_REDUCTION_PER_LETTER = 1.5 ether;
    ...
    function renew(string memory _name) public payable nonReentrant {
        ...
        uint256 _newExpiry = names[_name].expires + RENEWAL_PERIOD;
        
        names[_name].expires = _newExpiry;
        ...
        emit NameRenewed(_name, _newExpiry);
    }
